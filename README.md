...
```sh
find ./ -type f -exec sed -i -e "s/insensitive-strenum/$PACKAGE/g" {} \;
find ./ -type f -exec sed -i -e "s/insensitive_strenum/$MODULE/g" {} \;
find ./ -type f -exec sed -i -e "s/A case insensitive StrEnum/$PACKAGE_DESCRIPTION/g" {} \;
